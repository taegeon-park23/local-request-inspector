...
73. Later write-time migration-engine work if compatibility pressure justifies it
74. Bounded packaging polish only if a delivery milestone identifies a concrete readiness gap
## Why T001 Is First
