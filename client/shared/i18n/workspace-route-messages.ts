  ...
  workspaceRoute: {
    explorer: {
      header: {
        ...
        title: 'Collections',
        summary:
          'Persisted collections, nested request groups, and saved requests stay visible here. Keep navigation compact, focus on quick selection, and keep destructive cleanup inside row action menus.',
      ...
      notes: {
        ...
        navigationOnly:
          'The explorer stays navigation-first with compact rows, explicit request pin actions, and destructive cleanup inside row menus. Import and export stay in the companion workspace panel.',
        previewAdvisory:
      ...
      status: {
        ...
        exportBundleRequestLabelSingular: '{count} saved request definition',
        exportBundleRequestLabelPlural: '{count} saved request definitions',
        exportBundleMockRuleLabelSingular: '{count} mock rule',
        exportBundleMockRuleLabelPlural: '{count} mock rules',
        exportBundleScriptLabelSingular: '{count} saved script',
        exportBundleScriptLabelPlural: '{count} saved scripts',
        exportBundleLabelWithScripts: '{requestLabel}, {mockRuleLabel}, and {scriptLabel}',
        exportBundleLabelWithoutScripts: '{requestLabel} and {mockRuleLabel}',
    ...
    commandMenu: {
      ariaLabel: 'Workspace command entry',
      title: 'Workspace commands',
      description: 'Trigger major workspace actions from one place, or use the listed keyboard shortcuts directly.',
      actions: {
        openMenu: 'Command',
        closeMenu: 'Close',
        menuAriaLabel: 'Workspace command actions',
        newRequest: 'New request',
        quickRequest: 'Quick request',
        newCollection: 'New collection',
        newRequestGroup: 'New group',
        runSelected: 'Run selected',
      },
      shortcuts: {
        openMenu: 'Ctrl/Cmd+K',
    ...
    resultPanel: {
      ...
      source: {
        replayDraft: 'Replay draft',
        captureReplay: 'Opened from capture',
        historyReplay: 'Opened from history',
  ...
  workspaceRoute: {
    explorer: {
      header: {
        ...
        title: '컬렉션',
        summary:
          '지속된 컬렉션, 중첩 요청 그룹, 저장된 요청을 여기에서 함께 봅니다. 탐색은 최대한 컴팩트하게 유지하고, 파괴적 정리는 행 액션 메뉴 안으로 넣습니다.',
        authoringChip: '작성',
      ...
      notes: {
        ...
        navigationOnly:
          '탐색기는 컴팩트 행 기반의 선택/이동 중심으로 유지하고, 요청 고정은 별도 액션으로 두며, 파괴적 정리는 행 메뉴 안으로 넣습니다. 가져오기와 내보내기는 보조 workspace 패널에 남습니다.',
        previewAdvisory:
      ...
      status: {
        ...
        exportBundleRequestLabelSingular: '저장 요청 {count}개',
        exportBundleRequestLabelPlural: '저장 요청 {count}개',
        exportBundleMockRuleLabelSingular: 'mock rule {count}개',
        exportBundleMockRuleLabelPlural: 'mock rule {count}개',
        exportBundleScriptLabelSingular: '저장 스크립트 {count}개',
        exportBundleScriptLabelPlural: '저장 스크립트 {count}개',
        exportBundleLabelWithScripts: '{requestLabel}, {mockRuleLabel}, {scriptLabel}',
        exportBundleLabelWithoutScripts: '{requestLabel}, {mockRuleLabel}',
    ...
    commandMenu: {
      ariaLabel: '작업공간 명령 진입',
      title: '작업공간 명령',
      description: '주요 작업공간 동작을 한 곳에서 실행하거나, 표시된 단축키로 바로 실행할 수 있습니다.',
      actions: {
        openMenu: '명령',
        closeMenu: '닫기',
        menuAriaLabel: '작업공간 명령 동작',
        newRequest: '새 요청',
        quickRequest: '빠른 요청',
        newCollection: '새 컬렉션',
        newRequestGroup: '새 그룹',
        runSelected: '선택 실행',
      },
      shortcuts: {
        openMenu: 'Ctrl/Cmd+K',
    ...
    requestBuilder: {
      ...
      status: {
        ...
        savingInProgress: '요청 정의를 저장하는 중입니다...',
        runFallback: 'Run은 오른쪽 패널에 별도 관측 기록을 만듭니다.',
        runInProgress: '요청을 실행하는 중입니다...',
    ...
    resultPanel: {
      ...
      source: {
        replayDraft: '리플레이 draft',
        captureReplay: '캡처에서 열림',
        historyReplay: '히스토리에서 열림',
