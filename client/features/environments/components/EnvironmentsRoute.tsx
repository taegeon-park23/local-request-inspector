    ...
    <RoutePanelTabsLayout
      ...
      explorer={(
        ...
        <div className="environments-explorer">
          <header className="environments-explorer__header explorer-intro explorer-intro--compact">
