    ...
    <>
      ...
      <section className="shell-panel shell-panel--main" aria-label="Main work surface">
        <header className="section-placeholder__header">
          ...
          <h1>Settings</h1>
          <p>Settings is intentionally read-only in this MVP. It surfaces diagnostics and route hints instead of introducing persisted preferences before ownership is clear.</p>
        </header>
