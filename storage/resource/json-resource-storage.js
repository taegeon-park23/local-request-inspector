...
function buildResourceManifestPayload() {
  return {
    ...
    recordSchemaVersions: {
      collection: COLLECTION_RESOURCE_SCHEMA_VERSION,
      'request-group': REQUEST_GROUP_RESOURCE_SCHEMA_VERSION,
      request: REQUEST_RESOURCE_SCHEMA_VERSION,
      environment: ENVIRONMENT_RESOURCE_SCHEMA_VERSION,
      script: SCRIPT_RESOURCE_SCHEMA_VERSION,
